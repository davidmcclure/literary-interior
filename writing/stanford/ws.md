...
At the beginning of "An Introduction to the Structural Analysis of Narrative," Barthes' contribution to the 1966 special issue of *Communications* that would mark a crossroads in the history of narrative theory in the 20th century, Barthes begins by warning of the difficulties of taking an "inductive" approach to studying narrative:
...
Over the course of the 20th century, then, and especially since 1945, the edges of the American novel become permeable, porous, leaky -- the beginning starts to look back at what came before the beginning, and the end looks forward to what will come next. It is as if the narrative becomes a *sub*-narrative, in some sense, embedded inside of an implied larger narrative that stretches out to the left and right on either side. What's striking about this, though, is that it seems to represent a kind of literary-historical disproof or unravelling of the theoretical understanding of beginnings and ends that was being developed across the beginning and middle of the 20th century -- in fact, over the same period during which we can see this tectonic change in the actual structures of beginnings and ends in the American novel. We're reminded of the extent to which this *doesn't* correspond to the understanding of narrative structure developed by theorists like Peter Brooks, Frank Kermode,  Walter Benjamin, and Henry James -- the idea that beginnings and ends are useful to the extent that they provide an enclosure, a circle, a "fiction of concord" around around the text -- beginnings and ends as *births* and *deaths*, bright red lines of demarcation that are useful precisely to the extent to which they aren't permeable, aren't porous, aren't leaky.
...
Narratives are expressions of this desire for a "fullness of time," and we look to novels to experience a structural enclosure that is missing in real life, which tumbles out chaotically and without meaning. Narrative beginnings and ends are *useful* to us, Brooks and Kermode think, to the extent that they enforce this sense of demarcation, the degree to which they can measure off a discrete piece of narrative cloth and cut it cleanly at both sides. They are psychologically valuable to the extent to which they are not porous, not permeable, not leaky. We turn to narratives to the extent that they are sealed vessels for meaning, like dipping a cup into a stream -- the work of demarcation, of cordoning off some piece of thought or experience, is the fundamental competency of narrative.
