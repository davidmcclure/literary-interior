...
to take an example - back in college I wrote most of a senior thesis (before abandoning it for another topic) on two lines in hemingway and dostoevsky in which the act of writing is described as a process of getting rid of something, of purging something out of the mind and onto the page (Hemingway, in FWTBT - ""; Dostoevky, in Notes from Underground - ""). at the time I basically read all of hemingway and dostoevsky, over the course of a frantic three months, trying to find other instances of the same trope, and I've been thinking recently about taking this back up and seeing if it would be possible to suss it out computationally. but, you could go at this from two angles - you could start with the original hypothesis / question, emerging from the analog reading experience - try to write a program that would scan through a big stack of novels and pick out all places where writing is talked about as a process of purging. or you could ask the question in the more general case - when novels become self-reflexive, when novels start talking about the process of novelization, of writing - how do they talk about it, how is it described? is this particular analogy for writing - writing as a kind of psychological purging, a sort of Freudian discharge - widespread, representative of some larger literary-theoretic dynamic, or is it just an idiosyncrasy, essentially,one among thosuands of metaphors for writing, a tiny thread in a huge piece of cloth - an accident of Hemingway picking up a copy of Garnett's translation of Underground in Paris in the early 20s? is better to ask - where else is writing being talked about in this particular way? or just - how is writing being talked about? how should literary-computational hypotheses be _sized_ - general or specific, diffuse or concrete, big or small?

this isn't clear to me, and I think I swing back and forth on it from project to project. both seem to have risks - start too narrow, and you might miss a more interesting version of the question; start too broad, and you might get lost in a sea of leads and never wrestle things back into contact with literature, in a recognizable sense of the concept, as it differs from language or information at a more general register.
