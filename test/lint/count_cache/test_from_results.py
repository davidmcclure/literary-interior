...
def test_from_results(htrc_token_results):
    ...
    htrc_token_results.add_cache(c1)
    htrc_token_results.add_cache(c2)
    htrc_token_results.add_cache(c3)

    cache = CountCache.from_results(htrc_token_results.path)
