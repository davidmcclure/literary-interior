...
def test_dump_offsets(gail_data):
    ...
    assert Word.get('gail', 1910, 'one',   'CD', o1) == 10
    assert Word.get('gail', 1910, 'two',   'CD', o2) == 10
    assert Word.get('gail', 1910, 'three', 'CD', o3) == 10

    assert Word.get('gail', 1920, 'four',  'CD', o1) == 20
    assert Word.get('gail', 1920, 'five',  'CD', o2) == 20
    assert Word.get('gail', 1920, 'six',   'CD', o3) == 20

    assert Word.get('gail', 1930, 'seven', 'CD', o1) == 30
    assert Word.get('gail', 1930, 'eight', 'CD', o2) == 30
    assert Word.get('gail', 1930, 'nine',  'CD', o3) == 30
...
def test_round_years_to_decade(gail_data):
    ...
    # n1 -> 1900
    assert Word.get('gail', 1900, 'one',   'CD', o1) == 1
    assert Word.get('gail', 1900, 'two',   'CD', o2) == 1
    assert Word.get('gail', 1900, 'three', 'CD', o3) == 1

    # n2 + n3 -> 1910
    assert Word.get('gail', 1910, 'one',   'CD', o1) == 2
    assert Word.get('gail', 1910, 'two',   'CD', o2) == 2
    assert Word.get('gail', 1910, 'three', 'CD', o3) == 2
